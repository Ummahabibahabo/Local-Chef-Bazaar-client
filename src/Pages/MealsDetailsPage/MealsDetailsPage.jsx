...
//               className="btn btn-outline btn-error w-full rounded-full flex items-center justify-center gap-2"
//             >
...
//         <div className="mt-6">
//           <AddReviewForm foodId={_id} onReviewAdded={handleReviewAdded} />
//         </div>
//       </div>
//     </div>
//   );
